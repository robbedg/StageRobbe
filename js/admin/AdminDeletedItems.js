...
$(document).ready(function(){
    ...
    function checkLocalStorage() {
      var $pref = localStorage.getItem('admin-deleted-items');
      if ($pref !== null) {
    ...
    function setLocalStorage() {
      localStorage.setItem('admin-deleted-items', JSON.stringify({'limit' : $data.limit, 'sort_on' : $data.sort_on}));
    }
        ...
        $($items).each(function($index, $el) {
          $("#listingpage tbody").
            append($('<tr />')
              ...
              .append($('<td />')
                .append($('<a href="#" data-function="restore" />').addClass('btn btn-success btn-xs').text('Restore').attr('data-id', $el['id']))
                .append(' ')
                .append($('<a href="#" data-function="delete" />').addClass('btn btn-danger btn-xs').text('Delete').attr('data-id', $el['id']))
