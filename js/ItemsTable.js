...
$(document).ready(function(){
    ...
    function checkLocalStorage() {
      var $pref = localStorage.getItem('items');
      if ($pref !== null) {
    ...
    function setLocalStorage() {
      localStorage.setItem('items', JSON.stringify({'limit' : $data.limit, 'sorton' : $data.sorton}));
    }
    ...
    function callDB() {
      ...
      .done(function($response) {
        ...
        $($locations).each(function($index, $el) {
          $("#listingpage tbody").
            append($('<tr class="clickable-row" href="/index.php/items/view/' + $el['Item ID'] + '"/>')
              .append($('<td />').append($el['Item ID']))
              .append($('<td />').append($el['Created On'])));
          clickablerow();
